...
- As a user ISBAT save the message to global store(Context or Redux) when I press `Send` button


## Requirements 
- Add new folder in the root called `app`
- Create a new Branch in the following format: your name-ddmmyyyy e.g;; rajtejani-24082022
- Use React
...
- After completing task add a PR to merge your brnach with master branch.
